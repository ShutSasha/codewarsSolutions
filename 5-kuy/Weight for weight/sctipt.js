function orderWeight (strng) {
	...
	let str = strng.split(' ').sort((a, b) => a.split('').map(Number).reduce((total, item) => total + item) - b.split('').map(Number).reduce((total, item) => total + item)).map(Number);
...
console.log(orderWeight('22 2000 11 11 10003 123 1234000 44444444 9999'));